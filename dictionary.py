quote = [
    ...
    "Vision doesn’t usually come as a lightening bolt. "
    "Rather it comes as a slow crystallization of life challenges that we one day recognize as a "
    "beautiful diamond with great value to ourselves and others.\n– Dr. Michael Norwood",
    ...
    "Winners lose much more often than losers. So if you keep losing but you’re still trying, "
    ...
    "Enduring habits I hate... Yes, at the very bottom of my soul I feel grateful to all my misery and bouts of "
    "sickness and everything about me that is imperfect, "
    "because this sort of thing leaves me with a hundred backdoors through which I can escape from enduring habits."
...
# A list of greetings the bot sends to the user
bot_greetings = [
    "Hello!",
    "Hello there.",
...
# A list of greetings that triggers the bots response
user_greetings = [
    "hi",
    "hello",
    "hola",
